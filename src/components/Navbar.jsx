...
const Navbar = () => {
  ...
  return (
    <div className='absolute bottom-0 left-0 w-full lg:w-96 lg:h-full h-max bg-secondaryBackground lg:flex lg:flex-col lg:items-start lg:col-span-3 lg:row-span-12 lg:justify-start lg:gap-24 lg:static lg:border-r-2 lg:border-r-zinc-900'>
